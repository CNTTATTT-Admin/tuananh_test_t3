...
public class ThresholdController {
    ...
    public ResponseEntity<PlagiarismThresholds> getById(@PathVariable("id") Long id) throws IdInvalidException {
    ...
    public ResponseEntity<java.util.List<PlagiarismThresholds>> getThresholdByClass(@PathVariable("classId") Long classId) {

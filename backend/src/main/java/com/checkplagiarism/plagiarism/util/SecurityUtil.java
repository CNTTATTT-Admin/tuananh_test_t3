package com.checkplagiarism.plagiarism.util;
...
public class SecurityUtil {
    ...
    public String createAccessToken(String email, ResLoginDTO dto) {
        ...
        // Fetch permissions and role from user role
        ...
        if (dto.getUser().getRole() != null) {
            ...
            if (dto.getUser().getRole().getPermissions() != null) {
                for (com.checkplagiarism.plagiarism.domain.Permission p : dto.getUser().getRole().getPermissions()) {
                    listAuthority.add(p.getName()); 
                }
            }
        }
